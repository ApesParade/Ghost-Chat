/*
  ...
  - You are about to alter the column `expiry_hours` on the `Message` table. The data in that column could be lost. The data in that column will be cast from `Int` to `Float`.
